  ...
  render = (props) => {
    ...
    return <div className={classNames(classPrefix2, {
      ...
      <div className={boxCls} style={boxStyles}>
        <div className={`${classPrefix2}-input-box-icon`}><Icon_default code={60023} color="#ccc" /></div>
        <input className={`${classPrefix2}-input`} value={this.data.searchVal} onInput={(e) => {
        ...
        {!!this.data.searchVal && this.data.hasFocus && <div className={`${classPrefix2}-clear`} onClick={() => {
          this.setSearchValue("");
          inputClear?.();
