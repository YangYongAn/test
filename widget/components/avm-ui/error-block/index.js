...
var ErrorBlock = class extends Component {
  render = (props) => {
    ...
    let imageNode = <Icon code={59976} width="100px" height="100px" line-height="100px" text-align="center" className={`${classPrefix2}-image-img`} />;
    if (image) {
      if (typeof image === "string") {
        imageNode = <img src={image} className={`${classPrefix2}-image-img`} />;
      } else {
        imageNode = image;
      }
    }
...
export {
  error_block_default as default
};
