...
var MyCheckbox = class extends Component {
  ...
  render = (props) => {
    ...
    const iconEles = props.icon && props.selectedIcon ? this.data.checked ? props.selectedIcon : props.icon : defaultEleIcons;
