(function() {
	...
	var Input = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(Input, _Component2);
		function Input() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
			...
			_defineProperty(
				...
				function(val) {
					_this2.data.value = val;
					_this2.props.handleChange == null
						? void 0
						: _this2.props.handleChange(_this2.data.value);
				}
			);
			_defineProperty(_assertThisInitialized(_this2), "setHasFocus", function(
				state
			) {
				_this2.data.hasFocus = state;
			});
			_defineProperty(_assertThisInitialized(_this2), "render", function(props) {
				var _classNames;
				...
				var _this2$props = _this2.props,
					...
					disabledColor = _this2$props.disabledColor,
					textAlign = _this2$props.textAlign,
					placeholderColor = _this2$props.placeholderColor,
					placeholderClass = _this2$props.placeholderClass,
					disabled = _this2$props.disabled,
					readOnly = _this2$props.readOnly,
					_this2$props$placehol = _this2$props.placeholder,
					placeholder =
						_this2$props$placehol === void 0
							? "\u8BF7\u8F93\u5165\u6587\u672C"
							: _this2$props$placehol,
					maxLength = _this2$props.maxLength,
					minLength = _this2$props.minLength,
					max = _this2$props.max,
					min = _this2$props.min,
					clearable = _this2$props.clearable,
					enterPress = _this2$props.enterPress,
					onKeyDown = _this2$props.onKeyDown,
					_onFocus = _this2$props.onFocus,
					_onBlur = _this2$props.onBlur,
					onKeyUp = _this2$props.onKeyUp,
					handleClear = _this2$props.handleClear,
					_this2$props$autoComp = _this2$props.autoComplete,
					autoComplete =
						_this2$props$autoComp === void 0 ? "on" : _this2$props$autoComp,
					enterKeyHint = _this2$props.enterKeyHint,
					pattern = _this2$props.pattern,
				...
				return apivm.h(
					"div",
					_extends({className: classPrefix2$2 + "-wrapper"}, props),
					apivm.h("input", {
						id: id,
						value: _this2.data.value,
						className: classNames(
							classPrefix2$2,
							((_classNames = {}),
							(_classNames[classPrefix2$2 + "-disabled"] = disabled),
							(_classNames[classPrefix2$2 + "-readOnly"] = readOnly),
							_classNames)
						),
						style: iptStyles,
						...
						onInput: function onInput(e) {
							_this2.setValue(e.detail.value);
						},
					...
					clearable &&
						...
						apivm.h(
							"div",
							{
								className: classPrefix2$2 + "-clear",
								onClick: function onClick() {
									_this2.setValue("");
									handleClear == null ? void 0 : handleClear();
								}
							},
							apivm.h(Icon_default$1, {code: 59939, fontSize: "16px"})
						)
				);
			});
			_defineProperty(_assertThisInitialized(_this2), "css", function() {
	...
	var DemoInput = /*@__PURE__*/ (function(Component) {
		...
		if (Component) DemoInput.__proto__ = Component;
		DemoInput.prototype = Object.create(Component && Component.prototype);
		DemoInput.prototype.constructor = DemoInput;
		DemoInput.prototype.back = function() {
			api.closeWin();
		};
		DemoInput.prototype.onChange = function(val) {
			api.toast({
				msg: val
			});
		};
		DemoInput.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h(nav_bar_default, {onBack: this.back}, "Input"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						DemoBlock,
						{title: "基本的输入框组件"},
						apivm.h("avm-input", {placeholder: "请输入内容", value: this.data.value})
					),
					apivm.h(
						DemoBlock,
						{title: "带清除按钮"},
						apivm.h("avm-input", {
							placeholder: "请输入内容",
							clearable: true,
							placeholderClass: this.data.placeholder_class,
					...
					apivm.h(
						DemoBlock,
						{title: "上下布局", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							{prefixWidth: "100px"},
							apivm.h(
								"avm-list-item",
								{title: "用户名"},
								apivm.h("avm-input", {placeholder: "请输入用户名", clearable: true})
							),
							apivm.h(
								"avm-list-item",
								{title: "密码"},
					...
					apivm.h(
						DemoBlock,
						{title: "左右布局", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							{prefixWidth: "100px"},
							apivm.h(
					...
					apivm.h(
						DemoBlock,
						{title: "额外的操作按钮", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							{prefixWidth: "100px"},
							apivm.h(
								...
								{
									prefix: "短信验证码",
									extra: apivm.h("text", {style: "color: #9AC200"}, "发送验证码")
								},
								apivm.h("avm-input", {placeholder: "请输入验证码", clearable: true})
							)
						)
					),
					apivm.h(
	...
	DemoInput.css = {".page": {background: "#f2f2f2", padding: "0 16px"}};
	DemoInput.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-input", DemoInput);
	apivm.render(apivm.h("demo-input", null), "body");
})();
