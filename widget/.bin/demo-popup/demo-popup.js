(function() {
	...
	function mergeProps$1(defaultProps3, props) {
	...
	global.bodyStyle1 = {minHeight: "300px", padding: "16px"};
	global.bodyStyle2 = {minWidth: "200px", padding: "35px 16px 20px"};
	global.bodyStyle3 = {minHeight: "200px", padding: "35px 16px 20px"};
	global.bodyStyle4 = {height: "100px", padding: "16px"};
	global.borderRadiusStyle = {
		borderRadius: "8px 8px 0 0",
		minHeight: "300px",
		padding: "16px"
	};
	var DemoPopup = /*@__PURE__*/ (function(Component) {
		...
		if (Component) DemoPopup.__proto__ = Component;
		DemoPopup.prototype = Object.create(Component && Component.prototype);
		DemoPopup.prototype.constructor = DemoPopup;
		DemoPopup.prototype.back = function() {
			api.closeWin();
		};
		DemoPopup.prototype.setVisible = function(key, val) {
			api.toast({
		...
		DemoPopup.prototype.toggle = function() {
			this.data.visible = !this.data.visible;
		};
		DemoPopup.prototype.afterShow = function() {
			api.toast({
				msg: "关闭啦"
			});
		};
		DemoPopup.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(
					"safe-area",
					null,
					apivm.h("avm-nav-bar", {onBack: this.back}, "Popup"),
					apivm.h(
						DemoBlock,
						{title: "不同位置"},
						apivm.h(
							...
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible1", true);
									}
								},
								"底部弹出-带标题"
							),
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible2", true);
									}
								},
								"顶部弹出-带标题"
							),
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible3", true);
									}
								},
								"左侧弹出"
							),
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible4", true);
									}
								},
								"右侧弹出"
							)
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible5", true);
									}
								},
								"带按钮"
							)
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								...
								{
									onClick: function() {
										return this$1.setVisible("visible6", true);
									}
								},
								"可返回"
							)
				...
				apivm.h("avm-popup", {
					...
					handleClose: function() {
						return this$1.setVisible("visible1", false);
					},
					handleBack: function() {
						return this$1.setVisible("visible1", false);
					},
				...
				apivm.h("avm-popup", {
					...
					position: "top",
					handleClose: function() {
						return this$1.setVisible("visible2", false);
					},
					handleBack: function() {
						return this$1.setVisible("visible2", false);
					},
				...
				apivm.h("avm-popup", {
					...
					position: "left",
					handleClose: function() {
						return this$1.setVisible("visible3", false);
					},
					handleBack: function() {
						return this$1.setVisible("visible3", false);
					},
				...
				apivm.h("avm-popup", {
					...
					position: "right",
					handleClose: function() {
						return this$1.setVisible("visible4", false);
					},
					handleBack: function() {
						return this$1.setVisible("visible4", false);
					},
				...
				apivm.h("avm-popup", {
					...
					footBtnClick: function() {
						return this$1.setVisible("visible5", false);
					},
					handleClose: function() {
						return this$1.setVisible("visible5", false);
					},
				...
				apivm.h("avm-popup", {
					...
					isBack: true,
					handleClose: function() {
						return this$1.setVisible("visible6", false);
					},
					handleBack: function() {
						return this$1.setVisible("visible6", false);
					},
	...
	DemoPopup.css = {
		...
		".long-scroll-item": {lineHeight: "60px"}
	};
	DemoPopup.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-popup", DemoPopup);
	apivm.render(apivm.h("demo-popup", null), "body");
})();
