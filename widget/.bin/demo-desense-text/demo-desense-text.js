(function() {
	...
	// packages/avm-ui/src/components/desense-text/desense-text.tsx
	var classPrefix2$1 = "adm-desense-text";
	var defaultProps$1 = {
		defaultDesense: true
	};

	var DesenseText = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(DesenseText, _Component2);
		function DesenseText() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
				_key2 < _len2;
			...
			_defineProperty(_assertThisInitialized(_this2), "data", {
				desense: _this2.props.desence || _this2.props.defaultDesense
			});
			_defineProperty(
				...
				function(props) {
					_this2.props = mergeProps(defaultProps$1, props);
					var text = props.text,
						desenseText = props.desenseText;
					return apivm.h(
						"div",
						{className: classPrefix2$1},
						apivm.h("text", null, _this2.data.desense ? desenseText : text),
						apivm.h(
							"div",
							{
								onClick: function onClick() {
									_this2.data.desense = !_this2.data.desense;
									props.onChange && props.onChange(_this2.data.desense);
								},
								className: classPrefix2$1 + "-icon-wrap"
							},
							_this2.data.desense
								? apivm.h(Icon_default$1, {code: 59963})
								: apivm.h(Icon_default$1, {code: 59964})
						)
					);
				}
			);
	...
	// packages/avm-ui/src/components/desense-text/index.ts
	var desense_text_default = DesenseText;
	avm.define("avm-desense-text", DesenseText);
	...
	var DemoDesenseText = /*@__PURE__*/ (function(Component) {
		function DemoDesenseText(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) DemoDesenseText.__proto__ = Component;
		DemoDesenseText.prototype = Object.create(Component && Component.prototype);
		DemoDesenseText.prototype.constructor = DemoDesenseText;
		DemoDesenseText.prototype.back = function() {
			api.closeWin();
		};
		DemoDesenseText.prototype.render = function() {
			return apivm.h(
				"safe-area",
				null,
				apivm.h(nav_bar_default, {onBack: this.back}, "DesenseText"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(desense_text_default, {
						text: "18812341234",
						desenseText: "188****1234"
					})
				),
				apivm.h(
					DemoBlock,
	...
	DemoDesenseText.csslink = [
		"../../components/avm-ui/nav-bar/index.css",
		"../../components/avm-ui/desense-text/index.css",
		"../../components/avm-ui/demos/index.css"
	];
	apivm.define("demo-desense-text", DemoDesenseText);
	apivm.render(apivm.h("demo-desense-text", null), "body");
})();
