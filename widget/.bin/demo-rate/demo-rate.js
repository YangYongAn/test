(function() {
	...
	// packages/avm-ui/src/components/rate/rate.tsx
	...
	var Rate = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(Rate, _Component2);
		function Rate() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
			...
			_defineProperty(_assertThisInitialized(_this2), "data", {
				value: _this2.props.value || _this2.props.defaultValue || 0
			});
			_defineProperty(
				...
				function(val, props) {
					...
					props.rateChange == null ? void 0 : props.rateChange(_this2.data.value);
				}
			);
			_defineProperty(_assertThisInitialized(_this2), "render", function(props) {
				...
				var styles = {};
				var _props = props,
					_props$starSize = _props.starSize,
					starSize = _props$starSize === void 0 ? "22px" : _props$starSize,
					_props$activeColor = _props.activeColor,
					activeColor =
						_props$activeColor === void 0 ? "#faab0c" : _props$activeColor;
				styles["padding"] = "4px";
					...
					return apivm.h(
						"div",
						{
							className: (0, import_classnames.default)(
								classPrefix2$1 + "-star",
								((_ref = {}),
								(_ref[classPrefix2$1 + "-star-active"] = _this2.data.value >= v),
								(_ref[classPrefix2$1 + "-star-half"] = half),
								(_ref[classPrefix2$1 + "-star-readonly"] = props.readOnly),
								_ref)
							),
							style: _objectSpread2(
								_objectSpread2({}, styles),
								{},
								{color: _this2.data.value >= v ? activeColor : "#ddd"}
							),
							onClick: function onClick() {
								if (props.readOnly || props.disabled) return;
								if (props.allowClear && _this2.data.value === v) {
									_this2.setValue(0, props);
								} else {
									_this2.setValue(v, props);
								}
							}
						},
						props.character
				...
				return apivm.h(
					...
					starList.map(function(_, i) {
						return apivm.h(
							...
							{
								key: i,
								className: (0, import_classnames.default)(classPrefix2$1 + "-box")
							},
	...
	var DemoRate = /*@__PURE__*/ (function(Component) {
		function DemoRate(props) {
			Component.call(this, props);
		}

		if (Component) DemoRate.__proto__ = Component;
		DemoRate.prototype = Object.create(Component && Component.prototype);
		DemoRate.prototype.constructor = DemoRate;
		DemoRate.prototype.back = function() {
			api.closeWin();
		};
		DemoRate.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Rate"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
					...
					apivm.h(
						DemoBlock,
						{title: "半星"},
						apivm.h("avm-rate", {allowHalf: true, defaultValue: 2.5})
					),
					apivm.h(
						DemoBlock,
						{title: "只读"},
						apivm.h("avm-rate", {readOnly: true, value: 4})
					),
					apivm.h(
						DemoBlock,
						{title: "清除"},
						apivm.h(
							...
							apivm.h(
								"avm-space",
								{align: "center"},
								apivm.h("avm-rate", {defaultValue: 3, allowClear: true}),
								apivm.h("div", null, "可清除")
							),
							apivm.h(
								"avm-space",
								{align: "center"},
								apivm.h("avm-rate", {defaultValue: 3, allowClear: false}),
								apivm.h("div", null, "不可清除")
							)
						)
					),
					apivm.h(
						...
						apivm.h(
							"avm-space",
							{direction: "vertical"},
							apivm.h("avm-rate", {allowHalf: true, defaultValue: 2, character: "棒"}),
							apivm.h("avm-rate", {
								allowHalf: true,
								defaultValue: 1.5,
								character: "♤"
	...
	DemoRate.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-rate", DemoRate);
	apivm.render(apivm.h("demo-rate", null), "body");
})();
