(function() {
	...
	var AvmBaseRefresh = /*@__PURE__*/ (function(Component) {
		function AvmBaseRefresh(props) {
		...
		if (Component) AvmBaseRefresh.__proto__ = Component;
		AvmBaseRefresh.prototype = Object.create(Component && Component.prototype);
		AvmBaseRefresh.prototype.constructor = AvmBaseRefresh;
		AvmBaseRefresh.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseRefresh.prototype.onstatechange = function(e) {
		...
		AvmBaseRefresh.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Refresh"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
						...
						this.data.refreshState === "normal"
							? apivm.h("text", {class: "text_style"}, "下拉即可刷新")
							: null,
						apivm.h(
							"refresh",
							{
	...
	AvmBaseRefresh.css = {
		...
		".refreshStateDesc": {color: "#9ac200", fontSize: "13px"},
		".refreshIcon": {
			position: "absolute",
			width: "25px",
			height: "22px",
		...
		".text_style": {color: "#333", fontSize: "14px"}
	};
	apivm.define("avm-base-refresh", AvmBaseRefresh);
	apivm.render(apivm.h("avm-base-refresh", null), "body");
})();
