(function() {
	...
	var TemplateSgmSort = /*@__PURE__*/ (function(Component) {
		function TemplateSgmSort(props) {
			Component.call(this, props);
			this.data = {
		...
		if (Component) TemplateSgmSort.__proto__ = Component;
		TemplateSgmSort.prototype = Object.create(Component && Component.prototype);
		TemplateSgmSort.prototype.constructor = TemplateSgmSort;
		TemplateSgmSort.prototype.apiready = function() {};
		TemplateSgmSort.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("hoc-nav-bar-sgm", {title: "分类"}),
				apivm.h(
					"view",
		...
		return TemplateSgmSort;
	})(Component);
	TemplateSgmSort.css = {
		".page": {height: "100%", backgroundColor: "#f8f8f8"},
		".sort-container": {flex: "1", flexDirection: "row"}
	};
	apivm.define("template-sgm-sort", TemplateSgmSort);
	apivm.render(apivm.h("template-sgm-sort", null), "body");
})();
