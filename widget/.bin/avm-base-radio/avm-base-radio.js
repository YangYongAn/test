(function() {
	...
	var AvmBaseRadio = /*@__PURE__*/ (function(Component) {
		function AvmBaseRadio(props) {
			Component.call(this, props);
		}

		if (Component) AvmBaseRadio.__proto__ = Component;
		AvmBaseRadio.prototype = Object.create(Component && Component.prototype);
		AvmBaseRadio.prototype.constructor = AvmBaseRadio;
		AvmBaseRadio.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseRadio.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				...
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h("radio", {color: "#9ac200", value: "radio_one"})
				),
				apivm.h(
					DemoBlock,
					{title: "自定义icon"},
	...
	apivm.define("avm-base-radio", AvmBaseRadio);
	apivm.render(apivm.h("avm-base-radio", null), "body");
})();
