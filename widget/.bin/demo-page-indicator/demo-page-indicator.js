(function() {
	...
	var classPrefix$1 = "adm-page-indicator";
	var defaultProps$1 = {
	...
	var PageIndicator = /*#__PURE__*/ (function(_Component) {
		_inheritsLoose(PageIndicator, _Component);
					...
					dots.push(
						apivm.h("div", {
							...
							className: classNames(
								classPrefix$1 + "-dot",
								((_classNames = {}),
								(_classNames[classPrefix$1 + "-dot-active"] = props.current === i),
								_classNames)
							),
							style: {
				...
				return apivm.h(
					"div",
					{
						className: classNames(
							classPrefix$1,
							props.className,
							classPrefix$1 + "-" + props.direction,
							classPrefix$1 + "-color-" + props.color
						),
						style: props.style
					},
					dots
	...
	var DemoPageindicator = /*@__PURE__*/ (function(Component) {
		function DemoPageindicator(props) {
			Component.call(this, props);
		}

		if (Component) DemoPageindicator.__proto__ = Component;
		DemoPageindicator.prototype = Object.create(Component && Component.prototype);
		DemoPageindicator.prototype.constructor = DemoPageindicator;
		DemoPageindicator.prototype.back = function() {
			api.closeWin();
		};
		DemoPageindicator.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h(nav_bar_default, {onBack: this.back}, "PageIndicator"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						DemoBlock,
						{title: "基础用法"},
						apivm.h("avm-page-indicator", {total: 6, current: 1})
					),
					apivm.h(
						DemoBlock,
						{title: "白色", background: "#9AC200"},
						apivm.h("avm-page-indicator", {total: 5, current: 2, color: "white"})
					),
					apivm.h(
						DemoBlock,
						{title: "竖直方向"},
						apivm.h("avm-page-indicator", {
							total: 6,
							current: 3,
							direction: "vertical"
						})
		...
		return DemoPageindicator;
	})(Component);
	DemoPageindicator.css = {".page": {height: "100%", width: "100%"}};
	DemoPageindicator.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-pageindicator", DemoPageindicator);
	apivm.render(apivm.h("demo-pageindicator", null), "body");
})();
