(function() {
	...
	var TemplateFreSetaddress = /*@__PURE__*/ (function(Component) {
		function TemplateFreSetaddress(props) {
		...
		if (Component) TemplateFreSetaddress.__proto__ = Component;
		TemplateFreSetaddress.prototype = Object.create(
			Component && Component.prototype
		);
		TemplateFreSetaddress.prototype.constructor = TemplateFreSetaddress;
		TemplateFreSetaddress.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreSetaddress.prototype.apiready = function() {
        ...
        */
		...
		TemplateFreSetaddress.prototype.initDataList = function(values) {
			var component0 = [];
		...
		TemplateFreSetaddress.prototype.onselectchange = function(e) {
		...
		TemplateFreSetaddress.prototype.onselectcolumnchange = function(e) {
		...
		TemplateFreSetaddress.prototype.fnSelectAddressType = function(type) {
			this.data.type = type;
		};
		TemplateFreSetaddress.prototype.showToast = function(msg) {
			api.toast({
				msg: msg
			});
		};
		TemplateFreSetaddress.prototype.onRightButton = function() {
			api.confirm(
				{
					title: "提示",
					msg: "删除收货地址",
		...
		TemplateFreSetaddress.prototype.fnSave = function() {
		...
		TemplateFreSetaddress.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "main"},
		...
		return TemplateFreSetaddress;
	})(Component);
	TemplateFreSetaddress.css = {
		".main": {height: "100%", backgroundColor: "#eee", paddingBottom: "16px"},
		".nav-header": {
	...
	apivm.define("template-fre-setaddress", TemplateFreSetaddress);
	apivm.render(apivm.h("template-fre-setaddress", null), "body");
})();
