(function() {
	...
	var Tag = /*#__PURE__*/ (function(_Component) {
		...
		function Tag() {
			...
			_defineProperty(
				...
				function(props) {
					var _colorRecord$props$co, _props$borderColor, _classNames;
					...
					return apivm.h(
						...
						apivm.h(
							...
							{
								className: classNames(
									classPrefix$2 + "-wrapper",
									((_classNames = {}),
									(_classNames[classPrefix$2 + "-wrapper-disabled"] = props.isDisabled),
									(_classNames[classPrefix$2 + "-round"] = props.round),
									_classNames)
								),
								style: _objectSpread2(
									_objectSpread2({}, wrapperStyles),
									{},
									{display: _this.data.isShowTag ? "flex" : "none"}
								)
							},
							apivm.h(
								"span",
								{
									style: _objectSpread2({}, sizeMappings[props.size]),
							...
							props.isDelete &&
								apivm.h(
									"span",
									{
										className: classPrefix$2 + "-close",
										style: {color: sizeMappings[props.size].color},
										onClick: function onClick() {
											!props.isDisabled && (_this.data.isShowTag = false);
										}
									},
									"\u2715"
								)
	...
	var DemoTag = /*@__PURE__*/ (function(Component) {
		function DemoTag(props) {
			Component.call(this, props);
		}

		if (Component) DemoTag.__proto__ = Component;
		DemoTag.prototype = Object.create(Component && Component.prototype);
		DemoTag.prototype.constructor = DemoTag;
		DemoTag.prototype.back = function() {
			api.closeWin();
		};
		DemoTag.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Tag"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						...
						apivm.h(
							"avm-space",
							null,
							apivm.h("avm-tag", {color: "primary"}, "标签"),
							apivm.h("avm-tag", {round: true, color: "primary"}, "标签"),
							apivm.h("avm-tag", {color: "primary"}, "正常最多七个字啦啦啦啦啦")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							"avm-space",
							null,
							apivm.h("avm-tag", {color: "primary", size: "small"}, "标签"),
							apivm.h(
								"avm-tag",
								{round: true, color: "primary", size: "small"},
								"标签"
							),
							apivm.h(
								"avm-tag",
					...
					apivm.h(
						...
						apivm.h(
							"avm-space",
							null,
							apivm.h("avm-tag", {color: "primary", size: "large"}, "标签"),
							apivm.h(
								"avm-tag",
								{round: true, color: "primary", size: "large"},
								"标签"
							),
							apivm.h(
								"avm-tag",
					...
					apivm.h(
						...
						apivm.h(
							"avm-space",
							null,
							apivm.h("avm-tag", {color: "default"}, "Default"),
							apivm.h("avm-tag", {color: "primary"}, "Primary"),
							apivm.h("avm-tag", {color: "success"}, "Success"),
							apivm.h("avm-tag", {color: "warning"}, "Warning"),
							apivm.h("avm-tag", {color: "danger"}, "Danger")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							...
							apivm.h("avm-tag", {color: "#87d068", fill: "outline"}, "#87d068"),
							apivm.h("avm-tag", {color: "#ff6430", fill: "outline"}, "#ff6430")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							"avm-space",
							null,
							apivm.h("avm-tag", {color: "#2db7f5"}, "#2db7f5"),
							apivm.h("avm-tag", {color: "#87d068"}, "#87d068"),
							apivm.h("avm-tag", {color: "#108ee9"}, "#108ee9")
						)
					)
				)
			);
	...
	DemoTag.css = {".page": {height: "100%", width: "100%"}};
	DemoTag.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-tag", DemoTag);
	apivm.render(apivm.h("demo-tag", null), "body");
})();
