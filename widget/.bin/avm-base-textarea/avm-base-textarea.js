(function() {
	...
	var AvmBaseTextarea = /*@__PURE__*/ (function(Component) {
		function AvmBaseTextarea(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseTextarea.__proto__ = Component;
		AvmBaseTextarea.prototype = Object.create(Component && Component.prototype);
		AvmBaseTextarea.prototype.constructor = AvmBaseTextarea;
		AvmBaseTextarea.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseTextarea.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Textarea"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h("textarea", {placeholder: "请输入", class: "textarea"})
				),
				apivm.h(
					DemoBlock,
					{title: "输入字数限制"},
	...
	apivm.define("avm-base-textarea", AvmBaseTextarea);
	apivm.render(apivm.h("avm-base-textarea", null), "body");
})();
