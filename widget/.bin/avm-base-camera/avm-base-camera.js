(function() {
	...
	var AvmBaseCamera = /*@__PURE__*/ (function(Component) {
		function AvmBaseCamera(props) {
		...
		if (Component) AvmBaseCamera.__proto__ = Component;
		AvmBaseCamera.prototype = Object.create(Component && Component.prototype);
		AvmBaseCamera.prototype.constructor = AvmBaseCamera;
		AvmBaseCamera.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseCamera.prototype.onstop = function(e) {
			console.log("onstop");
		};
		AvmBaseCamera.prototype.onerror = function(e) {
			console.log("onerror");
		};
		AvmBaseCamera.prototype.oninitdone = function(e) {
			console.log("oninitdone");
		};
		AvmBaseCamera.prototype.onscancode = function(e) {
			var text = e.detail.text;
			api.alert({
				msg: text
			});
		};
		AvmBaseCamera.prototype.switchMode = function(e) {
			this.data.scanCodeMode = !this.data.scanCodeMode;
		};
		AvmBaseCamera.prototype.takePhoto = function(e) {
			var that = this;
		...
		AvmBaseCamera.prototype.startRecord = function(e) {
			var obj = document.getElementById("camera");
			obj.startRecord({
				quality: "high"
			});
		};
		AvmBaseCamera.prototype.stopRecord = function(e) {
			var that = this;
			var obj = document.getElementById("camera");
			obj.stopRecord(
				{
		...
		AvmBaseCamera.prototype.switchDevicePosition = function() {
			this.data.devicePosition =
				this.data.devicePosition == "back" ? "front" : "back";
		};
		AvmBaseCamera.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Camera"),
				apivm.h(
					"scroll-view",
		...
		return AvmBaseCamera;
	})(Component);
	AvmBaseCamera.css = {
		".page": {width: "100%", height: "100%", background: "#f2f2f2"},
		"#camera": {width: "100%", height: "400px", background: "#ccc"},
		".btns": {
			alignItems: "center",
			width: "100%",
			padding: "12px 0",
	...
	apivm.define("avm-base-camera", AvmBaseCamera);
	apivm.render(apivm.h("avm-base-camera", null), "body");
})();
