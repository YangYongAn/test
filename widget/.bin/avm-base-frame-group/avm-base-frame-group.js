(function() {
	...
	var AvmBaseFrameGroup = /*@__PURE__*/ (function(Component) {
		function AvmBaseFrameGroup(props) {
		...
		if (Component) AvmBaseFrameGroup.__proto__ = Component;
		AvmBaseFrameGroup.prototype = Object.create(Component && Component.prototype);
		AvmBaseFrameGroup.prototype.constructor = AvmBaseFrameGroup;
		AvmBaseFrameGroup.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseFrameGroup.prototype.apiready = function() {
			var frames = [];
		...
		AvmBaseFrameGroup.prototype.fnSetFrameGroupIndex = function(e) {
		...
		AvmBaseFrameGroup.prototype.onchange = function(e) {
			var index = e.detail.index;
			if (this.data.selectedIndex != index) {
				this.data.selectedIndex = index;
			}
		};
		AvmBaseFrameGroup.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "FrameGroup"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
		...
		return AvmBaseFrameGroup;
	})(Component);
	AvmBaseFrameGroup.css = {
		...
		".item-selected": {borderBottom: "2px solid #9af200"},
		".item-title": {color: "#444", fontSize: "14px"},
		".item-title-selected": {color: "#9af200"},
		"#frameGroup": {flex: "1"}
	};
	apivm.define("avm-base-frame-group", AvmBaseFrameGroup);
	apivm.render(apivm.h("avm-base-frame-group", null), "body");
})();
