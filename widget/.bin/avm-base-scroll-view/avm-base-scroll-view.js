(function() {
	...
	var AvmBaseScrollView = /*@__PURE__*/ (function(Component) {
		function AvmBaseScrollView(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseScrollView.__proto__ = Component;
		AvmBaseScrollView.prototype = Object.create(Component && Component.prototype);
		AvmBaseScrollView.prototype.constructor = AvmBaseScrollView;
		AvmBaseScrollView.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseScrollView.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "ScrollView"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						...
						apivm.h(
							"scroll-view",
							{class: "scroll-view", "scroll-x": true, "scroll-y": "false"},
							apivm.h("view", {class: "item item1"}),
							apivm.h("view", {class: "item item2"}),
							apivm.h("view", {class: "item item3"})
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							"scroll-view",
							{class: "scroll-view", "scroll-y": true},
							apivm.h("view", {class: "item item1"}),
							apivm.h("view", {class: "item item2"}),
							apivm.h("view", {class: "item item3"})
						)
		...
		return AvmBaseScrollView;
	})(Component);
	AvmBaseScrollView.css = {
		".page": {width: "100%", height: "100%", background: "#f2f2f2"},
		".scroll-view": {width: "100%", height: "150px"},
		".title": {padding: "10px 0", fontSize: "20px"},
		".item": {width: "100%", height: "100%"},
		".item1": {background: "#9ac200"},
		".item2": {background: "#fac200"},
		".item3": {background: "#1ec200"}
	};
	apivm.define("avm-base-scroll-view", AvmBaseScrollView);
	apivm.render(apivm.h("avm-base-scroll-view", null), "body");
})();
