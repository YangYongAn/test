(function() {
	...
	var AvmBaseRichText = /*@__PURE__*/ (function(Component) {
		function AvmBaseRichText(props) {
		...
		if (Component) AvmBaseRichText.__proto__ = Component;
		AvmBaseRichText.prototype = Object.create(Component && Component.prototype);
		AvmBaseRichText.prototype.constructor = AvmBaseRichText;
		AvmBaseRichText.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseRichText.prototype.apiready = function() {
			this.data.nodes = "<p>This is <i><b>rich text</b></i>.</p>";
		};
		AvmBaseRichText.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "RichText"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						DemoBlock,
						{title: "基础使用"},
						apivm.h("rich-text", {nodes: this.data.nodes})
					)
				)
			);
		};

		return AvmBaseRichText;
	})(Component);
	AvmBaseRichText.css = {
		".page": {width: "100%", height: "100%", background: "#f2f2f2"}
	};
	apivm.define("avm-base-rich-text", AvmBaseRichText);
	apivm.render(apivm.h("avm-base-rich-text", null), "body");
})();
