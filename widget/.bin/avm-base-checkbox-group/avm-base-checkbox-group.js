(function() {
	...
	var AvmBaseCheckboxGroup = /*@__PURE__*/ (function(Component) {
		function AvmBaseCheckboxGroup(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseCheckboxGroup.__proto__ = Component;
		AvmBaseCheckboxGroup.prototype = Object.create(
			Component && Component.prototype
		);
		AvmBaseCheckboxGroup.prototype.constructor = AvmBaseCheckboxGroup;
		AvmBaseCheckboxGroup.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseCheckboxGroup.prototype.checkboxgroupChanged = function(e) {
			api.toast({
				msg: JSON.stringify(e.detail.value)
			});
		};
		AvmBaseCheckboxGroup.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "CheckboxGroup"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
						...
						apivm.h(
							...
							apivm.h("checkbox", {
								color: "#9ac200",
								value: "checkbox_one",
								class: "checkbox_label_icon"
							}),
							apivm.h("text", {class: "checkbox_label_text"}, "选项一")
						),
						apivm.h(
							"label",
							{class: "checkbox_label"},
							...
							apivm.h("text", {class: "checkbox_label_text"}, "选项二")
						)
					)
				),
				apivm.h(
		...
		return AvmBaseCheckboxGroup;
	})(Component);
	AvmBaseCheckboxGroup.css = {
		".page": {
			width: "100%",
			height: "100%",
			background: "#f2f2f2",
		...
		".checkbox_label": {margin: "8px 0"},
		".checkbox_label_icon": {marginRight: "8px", width: "22px", height: "22px"},
		".checkbox_label_text": {fontSize: "14px", color: "#333"}
	};
	apivm.define("avm-base-checkbox-group", AvmBaseCheckboxGroup);
	apivm.render(apivm.h("avm-base-checkbox-group", null), "body");
})();
