(function() {
	...
	var DemoNavBar = /*@__PURE__*/ (function(Component) {
		function DemoNavBar(props) {
			Component.call(this, props);
		}

		if (Component) DemoNavBar.__proto__ = Component;
		DemoNavBar.prototype = Object.create(Component && Component.prototype);
		DemoNavBar.prototype.constructor = DemoNavBar;
		DemoNavBar.prototype.backClick = function() {
			api.alert({
				msg: "您点击了返回按钮"
			});
		};
		DemoNavBar.prototype.back = function() {
			api.closeWin();
		};
		DemoNavBar.prototype.render = function() {
			return apivm.h(
				"safe-area",
				null,
				apivm.h(nav_bar_default, {onBack: this.back}, "NavBar"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						DemoBlock,
						{title: "基础使用", padding: "0"},
						apivm.h(nav_bar_default, {onBack: this.backClick}, "标题")
					),

					apivm.h(
						DemoBlock,
						{title: "自定义返回按钮的文字", padding: "0"},
						apivm.h(nav_bar_default, {back: "返回", onBack: this.backClick}, "标题")
					),

					apivm.h(
						DemoBlock,
						{title: "返回按钮不显示图标", padding: "0"},
						apivm.h(
							nav_bar_default,
							{back: "返回", onBack: this.backClick, backArrow: false},
							"标题"
						)
					),
					...
					apivm.h(
						DemoBlock,
						{title: "自定义返回按钮图标", padding: "0"},
						apivm.h(nav_bar_default, {back: "返回", onBack: this.backClick}, "标题")
					),

					apivm.h(
						DemoBlock,
						{title: "自定义左侧区域", padding: "0"},
						apivm.h(
							nav_bar_default,
							{back: "返回", onBack: this.backClick, left: "关闭"},
							"标题"
						)
					),
					...
					apivm.h(
						DemoBlock,
						{title: "自定义标题内容", padding: "0"},
						apivm.h(
							nav_bar_default,
							{onBack: this.backClick},
							apivm.h(
								"view",
								{style: "align-items:center"},
								apivm.h("text", null, "标题"),
								apivm.h("text", {className: "my-nav-bar-subtitle"}, "副标题")
							)
						)
					),
					...
					apivm.h(
						DemoBlock,
						{title: "自定义高度和下边框", padding: "0"},
						apivm.h(
							nav_bar_default,
							{
								style: "height:36px;border-bottom:1px #eee solid",
								onBack: this.backClick
							},
							"标题"
						)
	...
	DemoNavBar.css = {".my-nav-bar-subtitle": {fontSize: "12px"}};
	DemoNavBar.csslink = [
		"../../components/avm-ui/icon/index.css",
		"../../components/avm-ui/nav-bar/index.css",
		"../../components/avm-ui/demos/index.css"
	];
	apivm.define("demo-nav-bar", DemoNavBar);
	apivm.render(apivm.h("demo-nav-bar", null), "body");
})();
