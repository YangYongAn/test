(function() {
	...
	var TemplateEtPlayVideo = /*@__PURE__*/ (function(Component) {
		function TemplateEtPlayVideo(props) {
			Component.call(this, props);
			this.data = {
		...
		if (Component) TemplateEtPlayVideo.__proto__ = Component;
		TemplateEtPlayVideo.prototype = Object.create(
			Component && Component.prototype
		);
		TemplateEtPlayVideo.prototype.constructor = TemplateEtPlayVideo;
		TemplateEtPlayVideo.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h("hoc-header-bar-et", {title: "查看公开课", isBack: true}),
				apivm.h(
					"view",
		...
		return TemplateEtPlayVideo;
	})(Component);
	TemplateEtPlayVideo.css = {
		".page": {height: "100%"},
		".main": {
			flex: "1",
	...
	apivm.define("template-et-play-video", TemplateEtPlayVideo);
	apivm.render(apivm.h("template-et-play-video", null), "body");
})();
