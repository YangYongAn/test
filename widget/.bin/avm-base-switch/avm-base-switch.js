(function() {
	...
	var AvmBaseSwitch = /*@__PURE__*/ (function(Component) {
		function AvmBaseSwitch(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseSwitch.__proto__ = Component;
		AvmBaseSwitch.prototype = Object.create(Component && Component.prototype);
		AvmBaseSwitch.prototype.constructor = AvmBaseSwitch;
		AvmBaseSwitch.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseSwitch.prototype.onchange = function(e) {
			api.toast({
				msg: e.detail.value ? "已开启" : "已关闭"
			});
		};
		AvmBaseSwitch.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				...
				apivm.h(
					...
					apivm.h(
						...
						apivm.h("switch", {class: "switch", onchange: this.onchange}),
						apivm.h(
							"view",
							{class: "switch-box"},
							apivm.h("switch", {
				...
				apivm.h(
					...
					apivm.h(
						"avm-space",
						null,
						apivm.h("switch", {class: "switch", disabled: true})
					)
				),
				apivm.h(
					DemoBlock,
	...
	AvmBaseSwitch.css = {
		...
		".switch-scale": {transform: "scale(1.5, 1.5)"}
	};
	apivm.define("avm-base-switch", AvmBaseSwitch);
	apivm.render(apivm.h("avm-base-switch", null), "body");
})();
