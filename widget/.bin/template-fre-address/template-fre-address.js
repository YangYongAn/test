(function() {
	var TemplateFreAddress = /*@__PURE__*/ (function(Component) {
		function TemplateFreAddress(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) TemplateFreAddress.__proto__ = Component;
		TemplateFreAddress.prototype = Object.create(
			Component && Component.prototype
		);
		TemplateFreAddress.prototype.constructor = TemplateFreAddress;
		TemplateFreAddress.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreAddress.prototype.onRightButton = function() {
			this.openSetAddressWin();
		};
		TemplateFreAddress.prototype.openSetAddressWin = function() {
			api.openWin({
				name: "setaddress",
				url: "../template-fre-setaddress/template-fre-setaddress.stml"
			});
		};
		TemplateFreAddress.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "main"},
				apivm.h(
		...
		return TemplateFreAddress;
	})(Component);
	TemplateFreAddress.css = {
		".main": {
			width: "100%",
			height: "100%",
			paddingBottom: "16px",
	...
	apivm.define("template-fre-address", TemplateFreAddress);
	apivm.render(apivm.h("template-fre-address", null), "body");
})();
