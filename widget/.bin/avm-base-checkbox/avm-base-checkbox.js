(function() {
	...
	var AvmBaseCheckbox = /*@__PURE__*/ (function(Component) {
		function AvmBaseCheckbox(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseCheckbox.__proto__ = Component;
		AvmBaseCheckbox.prototype = Object.create(Component && Component.prototype);
		AvmBaseCheckbox.prototype.constructor = AvmBaseCheckbox;
		AvmBaseCheckbox.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseCheckbox.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				...
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h("checkbox", {color: "#9ac200", value: "checkbox_two"})
				),
				apivm.h(
					DemoBlock,
					{title: "自定义icon"},
	...
	apivm.define("avm-base-checkbox", AvmBaseCheckbox);
	apivm.render(apivm.h("avm-base-checkbox", null), "body");
})();
