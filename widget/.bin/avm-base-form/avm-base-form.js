(function() {
	...
	var AvmBaseForm = /*@__PURE__*/ (function(Component) {
		function AvmBaseForm(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseForm.__proto__ = Component;
		AvmBaseForm.prototype = Object.create(Component && Component.prototype);
		AvmBaseForm.prototype.constructor = AvmBaseForm;
		AvmBaseForm.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseForm.prototype.onsubmit = function(e) {
			api.toast({
				msg: JSON.stringify(e.detail)
			});
		};
		AvmBaseForm.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Form"),
				apivm.h(
					"scroll-view",
					{class: "main", "show-scrollbar": false},
					apivm.h(
						DemoBlock,
						{title: "基础用法"},
						apivm.h(
							...
							apivm.h(
								...
								apivm.h(
									...
									apivm.h(
										...
										apivm.h("checkbox", {
											checked: true,
											value: "checkbox_one",
											class: "label_item_icon"
										}),
										apivm.h("text", {class: "label_item_text"}, "选项一")
									),
									apivm.h(
										"label",
										{class: "label_item"},
										...
										apivm.h("text", {class: "label_item_text"}, "选项二")
									)
								),
								apivm.h(
									"radio-group",
									{class: "item", name: "radio"},
									apivm.h(
										"label",
										{class: "label_item"},
										apivm.h("radio", {
									...
									apivm.h(
										"label",
										{class: "label_item"},
										apivm.h("radio", {value: "radio_two", class: "label_item_icon"}),
										apivm.h("text", {class: "label_item_text"}, "选项二")
									)
								),
								apivm.h(
									"view",
									{class: "item"},
									apivm.h("text", {class: "label_item"}, "input: "),
									apivm.h("input", {
										name: "input",
										placeholder: "请输入",
										class: "label_item_text"
									})
								),
								apivm.h(
									"view",
									{class: "item"},
									apivm.h("text", {class: "label_item"}, "textarea: "),
									apivm.h("textarea", {
										name: "textarea",
										placeholder: "请输入",
										class: "label_item_text"
								...
								apivm.h(
									"view",
									{class: "item"},
									apivm.h("text", {class: "label_item"}, "switch: "),
									apivm.h("switch", {checked: "true", name: "switch"})
								),
								apivm.h(
									"view",
									{class: "item"},
									apivm.h("text", {class: "label_item"}, "slider: "),
									apivm.h("slider", {value: "40", name: "slider"})
								)
							),
							apivm.h(
								"view",
	...
	AvmBaseForm.css = {
		...
		".form_btns": {flexDirection: "row", alignItems: "center", marginTop: "12px"},
		button: {margin: "0 10px"},
		input: {padding: "6px"},
		textarea: {padding: "6px"},
		".item": {flexDirection: "row", alignItems: "center", margin: "5px"},
		".label_item": {fontSize: "16px", color: "#333", marginRight: "12px"},
		".label_item_icon": {width: "22px", height: "22px", marginRight: "8px"},
		".label_item_text": {fontSize: "14px", color: "#333"}
	};
	apivm.define("avm-base-form", AvmBaseForm);
	apivm.render(apivm.h("avm-base-form", null), "body");
})();
