(function() {
	...
	var DemoBadge = /*@__PURE__*/ (function(Component) {
		function DemoBadge(props) {
			Component.call(this, props);
		}

		if (Component) DemoBadge.__proto__ = Component;
		DemoBadge.prototype = Object.create(Component && Component.prototype);
		DemoBadge.prototype.constructor = DemoBadge;
		DemoBadge.prototype.back = function() {
			api.closeWin();
		};
		DemoBadge.prototype.render = function() {
			return apivm.h(
				"safe-area",
				null,
				apivm.h("avm-nav-bar", {onBack: this.back}, "Badge"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								"avm-badge",
								{color: "#108ee9", content: "8", isDot: true},
								apivm.h("div", {className: "box"})
							),
							apivm.h(
								"avm-badge",
								{content: "28"},
							...
							apivm.h("avm-badge", null, apivm.h("div", {className: "box"}))
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							...
							apivm.h(
								"avm-badge",
								{color: "#9AC200", content: "8"},
								apivm.h("div", {className: "box"})
							),
							apivm.h(
								"avm-badge",
								{color: "#FA6400", content: "8", right: "100%", top: "100%"},
								apivm.h("div", {className: "box"})
							),
							apivm.h(
								"avm-badge",
								{content: "8", color: "#F7B500", right: "100%"},
								apivm.h("div", {className: "box"})
							),
							apivm.h(
								"avm-badge",
								{content: "8", top: "100%", top: "100%"},
								apivm.h("div", {className: "box"})
							)
						)
					),
					apivm.h(
						...
						apivm.h(
							"avm-space",
							{gap: "30px"},
							apivm.h("avm-badge", {content: "99+"}),
							apivm.h("avm-badge", {content: "新消息!"})
						)
					)
				)
			);
	...
	DemoBadge.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-badge", DemoBadge);
	apivm.render(apivm.h("demo-badge", null), "body");
})();
