(function() {
	...
	var AvmBaseListView = /*@__PURE__*/ (function(Component) {
		function AvmBaseListView(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseListView.__proto__ = Component;
		AvmBaseListView.prototype = Object.create(Component && Component.prototype);
		AvmBaseListView.prototype.constructor = AvmBaseListView;
		AvmBaseListView.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseListView.prototype.apiready = function() {
			this.initData(false);
		};
		AvmBaseListView.prototype.initData = function(loadMore) {
			var that = this;
		...
		AvmBaseListView.prototype.onscrolltolower = function() {
			this.initData(true);
		};
		AvmBaseListView.prototype.itemClick = function(e) {
			api.alert({
				msg: "当前项索引：" + e.currentTarget.index
			});
		};
		AvmBaseListView.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "ListView"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
						...
						apivm.h(
							"list-header",
							{class: "header"},
							apivm.h("text", {class: "header-text"}, "定义头部信息了~")
						),
	...
	AvmBaseListView.css = {
		...
		".title": {fontWeight: "500", fontSize: "16px", color: "#000"},
		".subtitle": {paddingTop: "10px", color: "#333", fontSize: "14px"},
		".header": {alignItems: "center", padding: "5px 0"},
		".header-text": {color: "#333", fontSize: "16px"},
		".footer": {justifyContent: "center", alignItems: "center"}
	};
	apivm.define("avm-base-list-view", AvmBaseListView);
	apivm.render(apivm.h("avm-base-list-view", null), "body");
})();
