(function() {
	...
	var TemplateEtCourse = /*@__PURE__*/ (function(Component) {
		function TemplateEtCourse(props) {
			Component.call(this, props);
			this.data = {
				current: 0,
				tabList: [
		...
		if (Component) TemplateEtCourse.__proto__ = Component;
		TemplateEtCourse.prototype = Object.create(Component && Component.prototype);
		TemplateEtCourse.prototype.constructor = TemplateEtCourse;
		TemplateEtCourse.prototype.tabChange = function(e) {
			this.data.current = e.detail.curTabIndex;
		};
		TemplateEtCourse.prototype.goto = function(data) {
			api.openWin({
				name: "template-et-course-detail",
				url: "../template-et-course-detail/template-et-course-detail.stml"
			});
		};
		TemplateEtCourse.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},
		...
		return TemplateEtCourse;
	})(Component);
	TemplateEtCourse.css = {".page": {height: "100%", backgroundColor: "#f8f8f8"}};
	apivm.define("template-et-course", TemplateEtCourse);
	apivm.render(apivm.h("template-et-course", null), "body");
})();
