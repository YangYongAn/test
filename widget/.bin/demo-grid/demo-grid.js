(function() {
	...
	var GridItem = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(GridItem, _Component2);
		function GridItem() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
	...
	var DemoGrid = /*@__PURE__*/ (function(Component) {
		function DemoGrid(props) {
			Component.call(this, props);
		}

		if (Component) DemoGrid.__proto__ = Component;
		DemoGrid.prototype = Object.create(Component && Component.prototype);
		DemoGrid.prototype.constructor = DemoGrid;
		DemoGrid.prototype.back = function() {
			api.closeWin();
		};
		DemoGrid.prototype.handleClick = function() {
			api.toast({
				msg: "点击啦"
			});
		};
		DemoGrid.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h(nav_bar_default, {onBack: this.back}, "Grid"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								"avm-grid-item",
								null,
								apivm.h("span", {class: "grid-demo-item-block"}, "A")
							),
							apivm.h(
								"avm-grid-item",
								null,
								apivm.h("span", {class: "grid-demo-item-block"}, "B")
							),
							apivm.h(
								"avm-grid-item",
								null,
								apivm.h("span", {class: "grid-demo-item-block"}, "C")
							),
							apivm.h(
								"avm-grid-item",
								null,
								apivm.h("span", {class: "grid-demo-item-block"}, "D")
							),
							apivm.h(
								"avm-grid-item",
								null,
								apivm.h("span", {class: "grid-demo-item-block"}, "E")
							)
						)
					),
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								"avm-grid-item",
								{span: 3, onClick: this.handleClick},
								apivm.h("span", {class: "grid-demo-item-block"}, "E")
							)
						)
					)
	...
	DemoGrid.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-grid", DemoGrid);
	apivm.render(apivm.h("demo-grid", null), "body");
})();
