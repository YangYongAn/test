(function() {
		...
		function Loading() {
			...
			_defineProperty(_assertThisInitialized(_this), "render", function(props) {
				...
				return apivm.h(
					...
					apivm.h("div", {
						className: classPrefix$1 + "-loading " + classPrefix$1 + "-" + size,
	...
	var Test = /*@__PURE__*/ (function(Component) {
		...
		Test.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Loading"),
				apivm.h(DemoBlock, {title: "默认"}, apivm.h(loading_default, null)),
				apivm.h(
					DemoBlock,
					{title: "黑色的 Loading"},
					apivm.h(loading_default, {color: "#333"})
				),
				apivm.h(
					DemoBlock,
					{title: "白色的 Loading", background: "#a5a5a5"},
					apivm.h(loading_default, {color: "white"})
				),
				apivm.h(
					DemoBlock,
					{title: "自动适配当前字号"},
					apivm.h(loading_default, {size: "small"}),
					apivm.h(loading_default, null),
					apivm.h(loading_default, {size: "big"})
				),
				apivm.h(
					DemoBlock,
					{title: "自动适配当前文本颜色"},
					apivm.h(
						"view",
						null,
						apivm.h(loading_default, {color: "#00b578"}),
						apivm.h("span", null, "绿色文字")
					),
					apivm.h(
						"view",
						null,
						apivm.h(loading_default, {color: "#ff3141"}),
						apivm.h("span", null, "红色文字")
					)
				)
			);
		};
	...
	Test.csslink = [
		...
		"../../components/avm-ui/loading/index.css"
	];
