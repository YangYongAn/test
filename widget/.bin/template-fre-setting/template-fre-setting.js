(function() {
	...
	var TemplateFreSetting = /*@__PURE__*/ (function(Component) {
		function TemplateFreSetting(props) {
		...
		if (Component) TemplateFreSetting.__proto__ = Component;
		TemplateFreSetting.prototype = Object.create(
			Component && Component.prototype
		);
		TemplateFreSetting.prototype.constructor = TemplateFreSetting;
		TemplateFreSetting.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreSetting.prototype.apiready = function() {
			var that = this;
		...
		TemplateFreSetting.prototype.fnItemAction = function(title) {
			if (title == "清除缓存") {
		...
		TemplateFreSetting.prototype.fnLogout = function() {
			api.confirm(
				{
					title: "提示",
					msg: "是否退出登录",
		...
		TemplateFreSetting.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "main"},
				...
				apivm.h(
					"view",
					{
						class: "item",
						onClick: function() {
							return this$1.fnItemAction("template-fre-about");
						}
					},
					apivm.h(
						"view",
		...
		return TemplateFreSetting;
	})(Component);
	TemplateFreSetting.css = {
		".main": {height: "100%", paddingBottom: "16px", background: "#fff"},
		".nav-header": {
	...
	apivm.define("template-fre-setting", TemplateFreSetting);
	apivm.render(apivm.h("template-fre-setting", null), "body");
})();
