(function() {
		...
		function Divider() {
			...
			_defineProperty(_assertThisInitialized(_this), "render", function(props) {
				...
				var _props = props,
					...
					borderTopWidth = _props.borderTopWidth,
				...
				var dividerLeftSty = Object.assign(
					{
						maxWidth: contentPosition === "left" ? "10%" : "auto"
					},
					dividerLineSty
				);
				var dividerRightSty = Object.assign(
					{
				...
				return apivm.h(
					"div",
					{
						className: classNames(
							classPrefix$1,
							classPrefix$1 + "-" + contentPosition
						)
					},
					apivm.h("div", {style: dividerLeftSty}),
					children.length > 0 &&
						apivm.h(
							"text",
							{className: classPrefix$1 + "-content", style: fontContentSty},
							children
						),
					apivm.h("div", {style: dividerRightSty})
				);
			});
			_defineProperty(_assertThisInitialized(_this), "css", function() {
				return "\n    .adm-divider {\n      align-items: center;\n      margin: 16px 0;\n      font-size: 14px;\n      flex-direction: row;\n      width: 100%;\n    }\n    .adm-divider-content {\n      flex: none;\n      padding: 0 16px;\n    }\n    ";
	...
	var DemoDivider = /*@__PURE__*/ (function(Component) {
		...
		DemoDivider.prototype.render = function() {
			return apivm.h(
				"safe-area",
				null,
				apivm.h(nav_bar_default, {onBack: this.back}, "Divider"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(DemoBlock, {title: "基础分割线"}, apivm.h(divider_default, null)),
					apivm.h(
						DemoBlock,
						{title: "带内容的分割线"},
						apivm.h(divider_default, null, "默认内容在中间"),
						apivm.h(divider_default, {contentPosition: "left"}, "左侧内容"),
						apivm.h(divider_default, {contentPosition: "right"}, "右侧内容")
					),
					apivm.h(
						DemoBlock,
						{title: "自定义样式"},
	...
	DemoDivider.csslink = [
		...
		"../../components/avm-ui/divider/index.css"
	];
