(function() {
	...
	var MainApiDetail = /*@__PURE__*/ (function(Component) {
		function MainApiDetail(props) {
		...
		if (Component) MainApiDetail.__proto__ = Component;
		MainApiDetail.prototype = Object.create(Component && Component.prototype);
		MainApiDetail.prototype.constructor = MainApiDetail;
		MainApiDetail.prototype.apiready = function() {};
		MainApiDetail.prototype.back = function() {
			api.closeWin();
		};
		MainApiDetail.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "main-api-detail", "v-if": "detailInfo"},
				apivm.h("avm-nav-bar", {onBack: this.back}, this.detailInfo.name),
				apivm.h(
					"scroll-view",
					{class: "main-api-detail-con"},
					apivm.h("text", {class: "detail-title"}, this.detailInfo.name),
					this.detailInfo.desc && this.detailInfo.desc.length
						? apivm.h(
								"view",
								null,
								(Array.isArray(this.detailInfo.desc)
									? this.detailInfo.desc
									: Object.values(this.detailInfo.desc)
								).map(function(item$1) {
									return apivm.h("text", {class: "detail-text detail-desc"}, item$1);
								})
						  )
						: null,
					this.detailInfo.enum
						? apivm.h(
								"view",
								null,
								apivm.h("text", {class: "detail-title"}, "取值范围："),
								apivm.h("text", {class: "detail-params-fields"}, this.detailInfo.enum)
						  )
						: null,
					this.detailInfo.params && this.detailInfo.params.length
						? apivm.h(
								"view",
								null,
								apivm.h("text", {class: "detail-title"}, "params"),
								(Array.isArray(this.detailInfo.params)
									? this.detailInfo.params
									: Object.values(this.detailInfo.params)
								).map(function(item$1) {
									return apivm.h(
										"view",
										{class: "detail-params"},
										apivm.h("text", {class: "detail-params-name"}, item$1.tip),
										item$1.desc && item$1.desc.length
											? apivm.h(
													"view",
													{class: "detail-params-detail"},
													apivm.h(
														"text",
														{class: "detail-text"},
														"类型：",
													...
													item$1.desc[0].fields
														? apivm.h("text", {class: "detail-text"}, "内部字段：")
														: null,
													item$1.desc[0].fields
														? apivm.h(
																"text",
																{class: "detail-params-fields"},
																item$1.desc[0].fields
														  )
														: null
											  )
						...
						: null,
					this.detailInfo.sampleCode
						? apivm.h(
								"view",
								null,
								apivm.h("text", {class: "detail-title"}, "示例代码"),
								apivm.h(
									"text",
									{class: "detail-params-fields"},
									this.detailInfo.sampleCode
						...
						: null,
					this.detailInfo.usability && this.detailInfo.usability.length
						? apivm.h(
								"view",
								null,
								apivm.h("text", {class: "detail-title"}, "可用性"),
								(Array.isArray(this.detailInfo.usability)
									? this.detailInfo.usability
									: Object.values(this.detailInfo.usability)
								).map(function(item$1) {
									return apivm.h("text", {class: "detail-text"}, item$1);
								})
						  )
						: null
				)
		...
		return MainApiDetail;
	})(Component);
	MainApiDetail.css = {
		".main-api-detail": {width: "100%", height: "100%"},
		".main-api-detail-con": {flex: "1", padding: "0 16px"},
		".detail-title": {
			padding: "22px 0 12px",
			color: "#333",
			fontSize: "20px",
		...
		".detail-desc": {paddingBottom: "12px"},
		".detail-params": {marginBottom: "12px", padding: "0 12px"},
		".detail-params-name": {paddingBottom: "12px"},
	...
	apivm.define("main-api-detail", MainApiDetail);
	apivm.render(apivm.h("main-api-detail", null), "body");
})();
