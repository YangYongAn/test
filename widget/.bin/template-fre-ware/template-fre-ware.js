(function() {
	var TemplateFreWare = /*@__PURE__*/ (function(Component) {
		function TemplateFreWare(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) TemplateFreWare.__proto__ = Component;
		TemplateFreWare.prototype = Object.create(Component && Component.prototype);
		TemplateFreWare.prototype.constructor = TemplateFreWare;
		TemplateFreWare.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreWare.prototype.onRightButton = function() {
			api.openFrame({
				name: "sharePage",
				url: "../share_frame/share_frame.stml"
			});
		};
		TemplateFreWare.prototype.fnMinus = function() {
			api.toast({
				msg: "减少商品数量"
			});
		};
		TemplateFreWare.prototype.fnAdd = function() {
			api.toast({
				msg: "增加商品数量"
			});
		};
		TemplateFreWare.prototype.fnOpenDetailWin = function(id, wareCount) {
			api.openWin({
				name: "ware" + id,
		...
		TemplateFreWare.prototype.fnOpenOrderWin = function() {
			api.openWin({
				name: "order",
				url: "../template-fre-order/template-fre-order.stml"
			});
		};
		TemplateFreWare.prototype.fnOpenShoppingCartWin = function() {
			api.openWin({
				name: "shoppingcart",
				url: "../template-fre-shoppingcart/template-fre-shoppingcart.stml"
			});
		};
		TemplateFreWare.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "main"},
				...
				apivm.h(
					"scroll-view",
					{class: "scrollView", "scroll-y": "true", "show-scrollbar": false},
					apivm.h(
						"view",
						{class: "swiper"},
						apivm.h("img", {
		...
		return TemplateFreWare;
	})(Component);
	TemplateFreWare.css = {
		".main": {width: "100%", height: "100%", background: "#f3f3f3"},
		".nav-header": {
	...
	apivm.define("template-fre-ware", TemplateFreWare);
	apivm.render(apivm.h("template-fre-ware", null), "body");
})();
