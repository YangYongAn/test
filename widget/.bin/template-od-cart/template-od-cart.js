(function() {
	...
	var TemplateOdCart = /*@__PURE__*/ (function(Component) {
		function TemplateOdCart(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) TemplateOdCart.__proto__ = Component;
		TemplateOdCart.prototype = Object.create(Component && Component.prototype);
		TemplateOdCart.prototype.constructor = TemplateOdCart;
		TemplateOdCart.prototype.apiready = function() {};
		TemplateOdCart.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},

				apivm.h("hoc-nav-bar-od", {msg: "购物车"}),

				apivm.h("hoc-shopping-header-od", null),

				apivm.h("hoc-shopping-list-od", null),

				apivm.h("hoc-shopping-footer-od", null)
			);
		};

		return TemplateOdCart;
	})(Component);
	TemplateOdCart.css = {
		".page": {height: "100%", backgroundColor: "#fff"},
		"scroll-view": {height: "100%"}
	};
	apivm.define("template-od-cart", TemplateOdCart);
	apivm.render(apivm.h("template-od-cart", null), "body");
})();
