(function() {
	...
	var AvmBaseText = /*@__PURE__*/ (function(Component) {
		function AvmBaseText(props) {
			Component.call(this, props);
		}

		if (Component) AvmBaseText.__proto__ = Component;
		AvmBaseText.prototype = Object.create(Component && Component.prototype);
		AvmBaseText.prototype.constructor = AvmBaseText;
		AvmBaseText.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseText.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Text"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						DemoBlock,
						{title: "普通文本"},
						apivm.h("text", {class: "text"}, "普通文本")
					),
					apivm.h(
						DemoBlock,
						{title: "粗体文本"},
						apivm.h("text", {class: "text bold"}, "粗体文本")
					),
					apivm.h(
						DemoBlock,
						{title: "斜体文本"},
						apivm.h("text", {class: "text italic"}, "斜体文本")
					),
					apivm.h(
						DemoBlock,
						{title: "Text-shadow 效果"},
						apivm.h("text", {class: "text shadow"}, "Text-shadow 效果")
					)
				)
			);
		};
	...
	AvmBaseText.css = {
		...
		".text": {height: "30px", fontSize: "18px"},
		".bold": {fontWeight: "bold"},
		".italic": {fontStyle: "italic"},
		".shadow": {textShadow: "2px 2px #f00"}
	};
	apivm.define("avm-base-text", AvmBaseText);
	apivm.render(apivm.h("avm-base-text", null), "body");
})();
