(function() {
	...
	var DemoButton = /*@__PURE__*/ (function(Component) {
		function DemoButton(props) {
			Component.call(this, props);
		}

		if (Component) DemoButton.__proto__ = Component;
		DemoButton.prototype = Object.create(Component && Component.prototype);
		DemoButton.prototype.constructor = DemoButton;
		DemoButton.prototype.back = function() {
			api.closeWin();
		};
		DemoButton.prototype.render = function() {
			return apivm.h(
				"safe-area",
				null,
				apivm.h(nav_bar_default, {onBack: this.back}, "Button"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						...
						apivm.h(
							space_default,
							{wrap: true},
							apivm.h(button_default2, null, "Default"),
							apivm.h(button_default2, {color: "primary"}, "Primary"),
							apivm.h(button_default2, {color: "success"}, "Success"),
							apivm.h(button_default2, {color: "danger"}, "Danger"),
							apivm.h(button_default2, {color: "warning"}, "Warning")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							button_default2,
							{block: true, color: "primary", size: "large"},
							"Block Button"
						)
					),
					apivm.h(
						...
						apivm.h(
							space_default,
							{wrap: true},
							apivm.h(button_default2, {color: "primary", fill: "solid"}, "Solid"),
							apivm.h(button_default2, {color: "primary", fill: "outline"}, "Outline"),
							apivm.h(button_default2, {color: "primary", fill: "none"}, "None")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							...
							apivm.h(button_default2, {size: "mini", color: "primary"}, "Mini"),
							apivm.h(button_default2, {size: "small", color: "primary"}, "Small"),
							apivm.h(button_default2, {size: "middle", color: "primary"}, "Middle"),
							apivm.h(button_default2, {size: "large", color: "primary"}, "Large")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							space_default,
							{wrap: true},
							apivm.h(button_default2, {disabled: true}, "Disabled"),
							apivm.h(button_default2, {disabled: true, color: "primary"}, "Disabled")
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							...
							apivm.h(
								button_default2,
								{loading: true, color: "primary", loadingText: "加载中"},
								"Loading"
							),
							apivm.h(
								button_default2,
					...
					apivm.h(
						...
						apivm.h(
							button_default2,
							null,
							apivm.h(space_default, null, "♀ ", apivm.h("span", null, "搜索"))
						)
					),
					apivm.h(
						DemoBlock,
						...
						apivm.h(
							...
							apivm.h(
								button_default2,
								{shape: "default", color: "primary"},
								"Default Button"
							),
							apivm.h(
								button_default2,
								{block: true, shape: "rounded", color: "primary"},
								"Rounded Button"
							),
							apivm.h(
								button_default2,
								{block: true, shape: "rectangular", color: "primary"},
								"Rectangular Button"
							)
						)
					)
	...
	DemoButton.css = {body: {color: "red"}};
	apivm.define("demo-button", DemoButton);
	apivm.render(apivm.h("demo-button", null), "body");
})();
