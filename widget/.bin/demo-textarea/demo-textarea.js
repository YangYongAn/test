(function() {
	...
	var classPrefix$1 = "adm-text-area";
	var defaultProps$1 = {
		rows: 2,
		showCount: false,
		autoSize: false,
	...
	var TextArea = /*#__PURE__*/ (function(_Component) {
		...
		function TextArea() {
			...
			_defineProperty(_assertThisInitialized(_this), "render", function(props) {
				var _classNames;
				_this.props = Object.assign({}, defaultProps$1, props);
				var _this$props = _this.props,
					...
					placeholder =
						_this$props$placehold === void 0
							? "\u8BF7\u8F93\u5165"
							: _this$props$placehold,
					_this$props$autoCompl = _this$props.autoComplete,
					autoComplete =
						_this$props$autoCompl === void 0 ? "on" : _this$props$autoCompl,
					placeholderColor = _this$props.placeholderColor,
					disabledColor = _this$props.disabledColor,
					maxLength = _this$props.maxLength;
				var count;
				if (typeof showCount === "function") {
					count = showCount(_this.data.value.length, maxLength);
				} else if (showCount) {
					count = apivm.h(
						"span",
						{className: classPrefix$1 + "-count"},
						maxLength === void 0
							? _this.data.value.length
							: _this.data.value.length + "/" + maxLength
					);
				}
				var textareaStyle = {
					fontSize: fontSize,
				...
				var textareaCls = classNames(
					...
					(_classNames[classPrefix$1 + "-readonly"] = readOnly),
					_classNames)
				);
				...
				return apivm.h(
					"div",
					{
						className: classNames(classPrefix$1 + "-wrapper", className),
						style: style
					},
					apivm.h("textarea", {
						...
						onInput: function onInput(e) {
							_this.setValue(e.detail.value);
						},
						onFocus: function onFocus(e) {
							props.inputFocus == null ? void 0 : props.inputFocus(e);
						},
						onBlur: function onBlur(e) {
							props.handleChange && props.handleChange(e.detail.value);
							props.inputBlur == null ? void 0 : props.inputBlur(e);
						}
					}),
					count
				);
	...
	var DemoTextarea = /*@__PURE__*/ (function(Component) {
		function DemoTextarea(props) {
			Component.call(this, props);
		}

		if (Component) DemoTextarea.__proto__ = Component;
		DemoTextarea.prototype = Object.create(Component && Component.prototype);
		DemoTextarea.prototype.constructor = DemoTextarea;
		DemoTextarea.prototype.back = function() {
			api.closeWin();
		};
		DemoTextarea.prototype.onChange = function(val) {
			api.toast({
				msg: val
			});
		};
		DemoTextarea.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h(nav_bar_default, {onBack: this.back}, "Textarea"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
					...
					apivm.h(
						DemoBlock,
						{title: "指定行数"},
						apivm.h("avm-textarea", {placeholder: "请输入内容", rows: 3})
					),
					apivm.h(
						DemoBlock,
						{title: "根据内容自动调整高度"},
						apivm.h("avm-textarea", {placeholder: "请输入内容", autoSize: true})
					),
					apivm.h(
						DemoBlock,
						{title: "字数统计"},
					...
					apivm.h(
						...
						apivm.h("avm-textarea", {
							defaultValue: "北极星垂地，\n东山月满川。",
							showCount: function(len, maxLength) {
								return apivm.h(
									"text",
									{
										style:
											"text-align: right; padding-top: 8px; color: #999; font-size: 12px;"
									},
									len,
									" / ",
									maxLength
	...
	DemoTextarea.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-textarea", DemoTextarea);
	apivm.render(apivm.h("demo-textarea", null), "body");
})();
