(function() {
	...
	var InfiniteScrollContent = /*#__PURE__*/ (function(_Component) {
		_inheritsLoose(InfiniteScrollContent, _Component);
	...
	var InfiniteScroll = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(InfiniteScroll, _Component2);
		function InfiniteScroll() {
			...
			_defineProperty(_assertThisInitialized(_this2), "render", function(props) {
				...
				return apivm.h(
					...
					props.children,
					apivm.h(InfiniteScrollContent, _extends({hasMore: props.hasMore}, props))
				);
			});
			_defineProperty(_assertThisInitialized(_this2), "css", function() {
	...
	var DemoInfinitescroll = /*@__PURE__*/ (function(Component) {
		function DemoInfinitescroll(props) {
		...
		if (Component) DemoInfinitescroll.__proto__ = Component;
		DemoInfinitescroll.prototype = Object.create(
			Component && Component.prototype
		);
		DemoInfinitescroll.prototype.constructor = DemoInfinitescroll;
		DemoInfinitescroll.prototype.apiready = function() {
			//like created
			this.loadMore();
		};
		DemoInfinitescroll.prototype.mockRequest = function() {
		...
		DemoInfinitescroll.prototype.loadMore = function() {
			var this$1 = this;

			setTimeout(function() {
				var append = this$1.mockRequest();
				this$1.setList(this$1.data.dataList.concat(append));
				this$1.setHasMore(append.length > 0);
			}, 1000);
		};
		DemoInfinitescroll.prototype.setList = function(list) {
			this.data.dataList = list;
		};
		DemoInfinitescroll.prototype.setHasMore = function(hasmore) {
			this.data.hasMore = hasmore;
		};
		DemoInfinitescroll.prototype.back = function() {
			api.closeWin();
		};
		DemoInfinitescroll.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "avm-infinite-scroll"),
				apivm.h(
					"avm-infinite-scroll",
					{
					...
					apivm.h(
						...
						this.data.dataList &&
							this.data.dataList.map(function(item, index) {
								return apivm.h("avm-list-item", {key: index}, item);
							})
					)
				)
			);
		...
		return DemoInfinitescroll;
	})(Component);
	DemoInfinitescroll.css = {".page": {height: "100%"}};
	DemoInfinitescroll.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-infinitescroll", DemoInfinitescroll);
	apivm.render(apivm.h("demo-infinitescroll", null), "body");
})();
