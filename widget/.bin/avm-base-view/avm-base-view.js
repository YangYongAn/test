(function() {
	...
	var AvmBaseView = /*@__PURE__*/ (function(Component) {
		function AvmBaseView(props) {
			Component.call(this, props);
		}

		if (Component) AvmBaseView.__proto__ = Component;
		AvmBaseView.prototype = Object.create(Component && Component.prototype);
		AvmBaseView.prototype.constructor = AvmBaseView;
		AvmBaseView.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseView.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "View"),
				apivm.h(
					"scroll-view",
	...
	AvmBaseView.css = {
		...
		".horizontal": {flexDirection: "row", width: "300px", height: "200px"},
		".vertical": {flexDirection: "column", width: "200px", height: "300px"},
		".item": {flex: "1"},
		".item1": {background: "#9ac200"},
		".item2": {background: "#fac200"},
		".item3": {background: "#1ec200"}
	};
	apivm.define("avm-base-view", AvmBaseView);
	apivm.render(apivm.h("avm-base-view", null), "body");
})();
