(function() {
	...
	var AvmBaseImage = /*@__PURE__*/ (function(Component) {
		function AvmBaseImage(props) {
			Component.call(this, props);
			this.data = {
				src:
					"http://img.mp.itc.cn/q_70,c_zoom,w_640/upload/20170421/06ec60b558ba4c1e81f8aa0f689fa873_th.jpeg",
				list: [
					{
						mode: "scaleToFill",
		...
		if (Component) AvmBaseImage.__proto__ = Component;
		AvmBaseImage.prototype = Object.create(Component && Component.prototype);
		AvmBaseImage.prototype.constructor = AvmBaseImage;
		AvmBaseImage.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseImage.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Image"),
				apivm.h(
					"scroll-view",
	...
	AvmBaseImage.css = {
		...
		".originImage": {width: "100%"},
		".image": {width: "150px", height: "150px", backgroundColor: "#ddd"}
	};
	apivm.define("avm-base-image", AvmBaseImage);
	apivm.render(apivm.h("avm-base-image", null), "body");
})();
