(function() {
	var TemplateFreCoupon = /*@__PURE__*/ (function(Component) {
		function TemplateFreCoupon(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) TemplateFreCoupon.__proto__ = Component;
		TemplateFreCoupon.prototype = Object.create(Component && Component.prototype);
		TemplateFreCoupon.prototype.constructor = TemplateFreCoupon;
		TemplateFreCoupon.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreCoupon.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "main"},
				apivm.h(
				...
				apivm.h(
					"scroll-view",
					{class: "listView", "scroll-y": "true", "show-scrollbar": false},
					apivm.h(
						"view",
						{class: "cell"},
						apivm.h(
							...
							apivm.h(
								"view",
								{class: "part4"},
								apivm.h("text", {class: "part4-top"}, "APP新客户50元体验券"),
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								"view",
								{class: "part4"},
								apivm.h("text", {class: "part4-top"}, "APP新客户600元体验券"),
		...
		return TemplateFreCoupon;
	})(Component);
	TemplateFreCoupon.css = {
		".main": {
			width: "100%",
			height: "100%",
			paddingBottom: "16px",
	...
	apivm.define("template-fre-coupon", TemplateFreCoupon);
	apivm.render(apivm.h("template-fre-coupon", null), "body");
})();
