(function() {
	...
	var AvmBaseFrame = /*@__PURE__*/ (function(Component) {
		function AvmBaseFrame(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseFrame.__proto__ = Component;
		AvmBaseFrame.prototype = Object.create(Component && Component.prototype);
		AvmBaseFrame.prototype.constructor = AvmBaseFrame;
		AvmBaseFrame.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseFrame.prototype.apiready = function() {
			this.initData(false);
		};
		AvmBaseFrame.prototype.initData = function(loadMore) {
			var that = this;
		...
		AvmBaseFrame.prototype.onscrolltolower = function() {
			this.initData(true);
		};
		AvmBaseFrame.prototype.itemClick = function(e) {
			api.alert({
				msg: "点击了项：" + e.currentTarget.index
			});
		};
		AvmBaseFrame.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Frame"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h("frame", {
	...
	apivm.define("avm-base-frame", AvmBaseFrame);
	apivm.render(apivm.h("avm-base-frame", null), "body");
})();
