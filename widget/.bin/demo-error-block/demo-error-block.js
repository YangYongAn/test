(function() {
	...
	var classPrefix2$1 = "adm-error-block";
	var ErrorBlockText = {
		default: {
			title: "\u9875\u9762\u9047\u5230\u4E00\u4E9B\u5C0F\u95EE\u9898",
			description: "\u5F85\u4F1A\u6765\u8BD5\u8BD5"
	...
	var ErrorBlock = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(ErrorBlock, _Component2);
		function ErrorBlock() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
			...
			_defineProperty(_assertThisInitialized(_this2), "render", function(props) {
				...
				var _this2$props = _this2.props,
					...
					fullPage = _this2$props.fullPage,
					children = _this2$props.children,
					imageWidth = _this2$props.imageWidth,
					imageHeight = _this2$props.imageHeight,
					imageHeightFullPage = _this2$props.imageHeightFullPage,
					imageWidthFullPage = _this2$props.imageWidthFullPage;
				var contentPack = ErrorBlockText[status];
				var des =
					"description" in _this2.props ? description : contentPack.description;
				var errTitle = "title" in props ? title : contentPack.title;
				var imageNode = apivm.h(Icon$1, {
					code: 59976,
					width: "100px",
					height: "100px",
					"line-height": "100px",
					"text-align": "center",
					className: classPrefix2$1 + "-image-img"
				});
				if (image) {
					if (typeof image === "string") {
						imageNode = apivm.h("img", {
							src: image,
							className: classPrefix2$1 + "-image-img"
						});
					} else {
				...
				var errTitleCls = classNames(
					classPrefix2$1 + "-description-title",
					((_classNames = {}),
					(_classNames[classPrefix2$1 + "-full-page-description-title"] = fullPage),
					_classNames)
				);
				...
				return apivm.h(
					"div",
					{
						className: classNames(
							classPrefix2$1,
							((_classNames2 = {}),
							(_classNames2[classPrefix2$1 + "-full-page"] = fullPage),
							_classNames2)
						),
						style: {}
					},
					apivm.h(
						"div",
						{className: classPrefix2$1 + "-image", style: imageStyles},
						imageNode
					),
					apivm.h(
						"div",
						{
							className: classNames(
								classPrefix2$1 + "-description",
								((_classNames3 = {}),
								(_classNames3[classPrefix2$1 + "-full-page-description"] = fullPage),
								_classNames3)
							)
						},

						formatLabel(errTitle, errTitleCls),
						formatLabel(des, classPrefix2$1 + "-description-subtitle")
					),

					children && formatLabel(children, classPrefix2$1 + "-content")
				);
			});
			_defineProperty(_assertThisInitialized(_this2), "css", function() {
	...
	var DemoErrorblock = /*@__PURE__*/ (function(Component) {
		function DemoErrorblock(props) {
			Component.call(this, props);
		}

		if (Component) DemoErrorblock.__proto__ = Component;
		DemoErrorblock.prototype = Object.create(Component && Component.prototype);
		DemoErrorblock.prototype.constructor = DemoErrorblock;
		DemoErrorblock.prototype.back = function() {
			api.closeWin();
		};
		DemoErrorblock.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "ErrorBlock"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						DemoBlock,
						{title: "四种状态", padding: "0", border: "none"},
						apivm.h(
							"avm-space",
							{block: true, direction: "vertical", gap: "16px"},
							apivm.h("avm-error-block", {status: "default", imageHeight: "150px"}),
							apivm.h("avm-error-block", {status: "disconnected"}),
							apivm.h("avm-error-block", {status: "empty"}),
							apivm.h("avm-error-block", {status: "busy"})
						)
					),
					apivm.h(
						DemoBlock,
						{title: "全屏", padding: "0", border: "none"},
						apivm.h("avm-error-block", {fullPage: true})
					),
					apivm.h(
						DemoBlock,
						{title: "自定义", padding: "0", border: "none"},
						apivm.h(
							"avm-error-block",
							{
								image: "../../image/cf.png",
								imgHeight: "150px",
								description: apivm.h("text", null, "Customize Description")
							},
							apivm.h("avm-button", {color: "primary"}, "Create Now")
						)
					)
				)
			);
		...
		return DemoErrorblock;
	})(Component);
	DemoErrorblock.css = {".page": {background: "#f2f2f2"}};
	DemoErrorblock.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-errorblock", DemoErrorblock);
	apivm.render(apivm.h("demo-errorblock", null), "body");
})();
