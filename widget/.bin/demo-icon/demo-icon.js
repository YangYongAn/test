(function() {
	...
	var DemoIcon = /*@__PURE__*/ (function(Component) {
		function DemoIcon(props) {
			Component.call(this, props);
		}

		if (Component) DemoIcon.__proto__ = Component;
		DemoIcon.prototype = Object.create(Component && Component.prototype);
		DemoIcon.prototype.constructor = DemoIcon;
		DemoIcon.prototype.back = function() {
			api.closeWin();
		};
		DemoIcon.prototype.handleClick = function() {
			api.toast({
				msg: "点击啦"
			});
		};
		DemoIcon.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				...
				apivm.h(
					...
					apivm.h(
						DemoBlock,
						{title: "基础用法"},
						apivm.h("avm-icon", {code: 60000}),
						apivm.h("avm-icon", {name: "CheckOutline"}),
						apivm.h("avm-icon", {type: "CheckOutline"})
					)
				)
			);
		};
	...
	apivm.define("demo-icon", DemoIcon);
	apivm.render(apivm.h("demo-icon", null), "body");
})();
