(function() {
	...
	var AvmBaseGridView = /*@__PURE__*/ (function(Component) {
		function AvmBaseGridView(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseGridView.__proto__ = Component;
		AvmBaseGridView.prototype = Object.create(Component && Component.prototype);
		AvmBaseGridView.prototype.constructor = AvmBaseGridView;
		AvmBaseGridView.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseGridView.prototype.apiready = function() {
			this.initData(false);
		};
		AvmBaseGridView.prototype.initData = function(loadMore) {
			var that = this;
		...
		AvmBaseGridView.prototype.onscrolltolower = function() {
			this.initData(true);
		};
		AvmBaseGridView.prototype.itemClick = function(e) {
			api.alert({
				msg: "点击了项：" + e.currentTarget.index
			});
		};
		AvmBaseGridView.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "GridView"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
	...
	AvmBaseGridView.css = {
		...
		".title": {fontWeight: "500", color: "#fff", fontSize: "14px"},
		".footer": {justifyContent: "center", alignItems: "center", height: "44px"}
	};
	apivm.define("avm-base-grid-view", AvmBaseGridView);
	apivm.render(apivm.h("avm-base-grid-view", null), "body");
})();
