(function() {
	...
	var AvmBaseProgress = /*@__PURE__*/ (function(Component) {
		function AvmBaseProgress(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseProgress.__proto__ = Component;
		AvmBaseProgress.prototype = Object.create(Component && Component.prototype);
		AvmBaseProgress.prototype.constructor = AvmBaseProgress;
		AvmBaseProgress.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseProgress.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Progress"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h("progress", {class: "progress", value: "30"}),
							apivm.h("progress", {
								class: "progress",
								value: "50",
								activeColor: "#9ac200"
							}),
							apivm.h("progress", {class: "progress", value: "90", active: true})
						)
					)
				)
			);
		...
		return AvmBaseProgress;
	})(Component);
	AvmBaseProgress.css = {
		".page": {width: "100%", height: "100%", background: "#f2f2f2"},
		".progress": {width: "60%"}
	};
	apivm.define("avm-base-progress", AvmBaseProgress);
	apivm.render(apivm.h("avm-base-progress", null), "body");
})();
