(function() {
	...
	var Card = /*#__PURE__*/ (function(_Component) {
		...
		function Card() {
			...
			_defineProperty(_assertThisInitialized(_this), "render", function(props) {
				...
				var renderHeader = function renderHeader() {
					...
					return apivm.h(
						...
						props.title.children
							...
							: apivm.h(
									"text",
									{className: classPrefix$1 + "-header-title", style: props.headerStyle},
									props.title
							  ),
						props.extra &&
							apivm.h(
								"text",
								{className: classPrefix$1 + "-header-extra"},
								props.extra
							)
					);
				};
				var renderBody = function renderBody() {
					...
					props.children.map(function(item) {
						if (typeof item === "string") {
							children = apivm.h("text", {class: props.bodyClassName}, item);
						} else {
					...
					return apivm.h(
						"div",
						{
							className: classNames$1(classPrefix$1 + "-body", props.bodyClassName),
				...
				return apivm.h(
					"div",
					{className: classPrefix$1, onClick: props.onClick, style: props.style},
					renderHeader(),
					renderBody()
				);
			});
	...
	var Test = /*@__PURE__*/ (function(Component) {
		...
		Test.prototype.onHeaderClick = function() {
			api.alert({
				msg: "点击了卡片Header区域"
			});
		};
		Test.prototype.onBodyClick = function() {
			api.alert({
				msg: "点击了卡片Body区域"
			});
		};
		Test.prototype.render = function() {
			...
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Card"),
				apivm.h(
					DemoBlock,
					{title: "基本用法", background: "gray"},
					apivm.h(
						"avm-card",
						{
							title: "卡片标题",
							onClick: function() {
								return this$1.onClick();
							}
						},
						"卡片内容"
					)
				...
				apivm.h(
					DemoBlock,
					{title: "自定义卡片样式", background: "gray"},
					apivm.h(
						"avm-card",
						{bodyClassName: "customBody", title: "卡片标题"},
						apivm.h("text", null, "卡片内容")
					)
				)
			);
		};
	...
	Test.css = {
		".page": {position: "relative", height: "100%", backgroundColor: "#f3f3f3"},
		".customBody": {color: "#00b578"}
	};
