(function() {
	var TemplateFreShoppingcart = /*@__PURE__*/ (function(Component) {
		function TemplateFreShoppingcart(props) {
		...
		if (Component) TemplateFreShoppingcart.__proto__ = Component;
		TemplateFreShoppingcart.prototype = Object.create(
			Component && Component.prototype
		);
		TemplateFreShoppingcart.prototype.constructor = TemplateFreShoppingcart;
		TemplateFreShoppingcart.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreShoppingcart.prototype.fnOpenDetailWin = function(id, wareCount) {
			api.openWin({
				name: "ware" + id,
		...
		TemplateFreShoppingcart.prototype.fnMinus = function() {
			api.toast({
				msg: "减少商品数量"
			});
		};
		TemplateFreShoppingcart.prototype.fnAdd = function(e) {
			api.toast({
				msg: "增加商品数量"
			});
		};
		TemplateFreShoppingcart.prototype.fnSelectAll = function(e) {
			api.toast({
				msg: "全选"
			});
		};
		TemplateFreShoppingcart.prototype.fnCloseWin = function() {
			api.closeWin();
		};
		TemplateFreShoppingcart.prototype.fnOpenOrderWin = function() {
			api.openWin({
				name: "order",
				url: "../template-fre-order/template-fre-order.stml"
			});
		};
		TemplateFreShoppingcart.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "main"},
				...
				apivm.h(
					...
					apivm.h(
						"scroll-view",
						{"scroll-y": "true", class: "listView", "show-scrollbar": false},
						apivm.h(
							"view",
							{class: "cell"},
							apivm.h(
		...
		return TemplateFreShoppingcart;
	})(Component);
	TemplateFreShoppingcart.css = {
	...
	apivm.define("template-fre-shoppingcart", TemplateFreShoppingcart);
	apivm.render(apivm.h("template-fre-shoppingcart", null), "body");
})();
