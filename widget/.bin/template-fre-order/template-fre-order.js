(function() {
	var TemplateFreOrder = /*@__PURE__*/ (function(Component) {
		function TemplateFreOrder(props) {
		...
		if (Component) TemplateFreOrder.__proto__ = Component;
		TemplateFreOrder.prototype = Object.create(Component && Component.prototype);
		TemplateFreOrder.prototype.constructor = TemplateFreOrder;
		TemplateFreOrder.prototype.onLeftButton = function() {
			api.closeWin();
		};
		TemplateFreOrder.prototype.onpaymethodchange = function(name) {
			api.toast({
				msg: "付款方式为" + name,
				location: "middle"
			});
		};
		TemplateFreOrder.prototype.fnBuy = function() {
			api.toast({
				msg: "演示版本，不能支付",
				location: "middle"
			});
		};
		TemplateFreOrder.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "main"},
		...
		return TemplateFreOrder;
	})(Component);
	TemplateFreOrder.css = {
	...
	apivm.define("template-fre-order", TemplateFreOrder);
	apivm.render(apivm.h("template-fre-order", null), "body");
})();
