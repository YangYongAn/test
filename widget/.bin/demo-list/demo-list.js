(function() {
	...
	var DemoList = /*@__PURE__*/ (function(Component) {
		function DemoList(props) {
			Component.call(this, props);
		}

		if (Component) DemoList.__proto__ = Component;
		DemoList.prototype = Object.create(Component && Component.prototype);
		DemoList.prototype.constructor = DemoList;
		DemoList.prototype.clickBtn = function() {
			api.toast({
				msg: "点击列表了~"
			});
		};
		DemoList.prototype.back = function() {
			api.closeWin();
		};
		DemoList.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h(nav_bar_default, {onBack: this.back}, "List"),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						...
						apivm.h(
							"avm-list",
							null,
							apivm.h("avm-list-item", null, "单元格"),
							apivm.h("avm-list-item", null, "单元格"),
							apivm.h("avm-list-item", null, "单元格")
						)
					),
					apivm.h(
						DemoBlock,
						{title: "可点击的列表", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							null,
							apivm.h("avm-list-item", {onClick: this.clickBtn}, "单元格"),
							apivm.h("avm-list-item", {onClick: this.clickBtn}, "单元格"),
							apivm.h("avm-list-item", {onClick: this.clickBtn}, "单元格")
						)
					),
					apivm.h(
						DemoBlock,
						{title: "复杂布局", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							null,
							apivm.h(
								"avm-list-item",
								{extra: apivm.h("text", {className: "icon_size"}, "右侧占位")},
								"单元格"
							),
							apivm.h(
								"avm-list-item",
					...
					apivm.h(
						DemoBlock,
						{title: "列表禁用", padding: "0", border: "none"},
						apivm.h(
							"avm-list",
							null,
							apivm.h(
								"avm-list-item",
								{
									disabled: true,
									clickable: true,
									prefix: apivm.h("text", {className: "icon_size"}, "Prefix占位")
								},
								"单元格"
							),
							apivm.h(
	...
	DemoList.css = {
		...
		".icon_size": {fontSize: "12px", color: "#999"}
	};
	DemoList.csslink = [
		"../../components/avm-ui/nav-bar/index.css",
		"../../components/avm-ui/demos/index.css"
	];
	apivm.define("demo-list", DemoList);
	apivm.render(apivm.h("demo-list", null), "body");
})();
