(function() {
	...
	var classPrefix2$1 = "adm-image";
	var defaultProps$2 = {
		fit: "fill",
		placeholder: apivm.h(
			"div",
			{className: classPrefix2$1 + "-tip"},
	...
	var Image = /*#__PURE__*/ (function(_Component2) {
		_inheritsLoose(Image, _Component2);
		function Image() {
			var _this2;
			for (
				var _len2 = arguments.length, args = new Array(_len2), _key2 = 0;
			...
			_defineProperty(
				...
				function(status) {
					_this2.data.loaded = status;
				}
			);
			_defineProperty(_assertThisInitialized(_this2), "setFailed", function(
				status
			) {
				_this2.data.failed = status;
			});
			_defineProperty(_assertThisInitialized(_this2), "render", function(props) {
				...
				var renderInner = function renderInner() {
					...
					return apivm.h(
						"view",
						{className: classPrefix2$1 + "-wrapper"},
						imgs(),
						apivm.h(
							"div",
							{
								className: !_this2.data.loaded
									? classPrefix2$1 + "-placeholder-wrapper"
									: ""
							},
							!_this2.data.loaded && props.placeholder
						)
					);
				};
				return apivm.h(
					"div",
					{className: classPrefix2$1, style: style},
					renderInner()
				);
			});
			_defineProperty(_assertThisInitialized(_this2), "css", function() {
	...
	var DemoImage = /*@__PURE__*/ (function(Component) {
		...
		if (Component) DemoImage.__proto__ = Component;
		DemoImage.prototype = Object.create(Component && Component.prototype);
		DemoImage.prototype.constructor = DemoImage;
		DemoImage.prototype.back = function() {
			api.closeWin();
		};
		DemoImage.prototype.handleClick = function() {
			api.toast({
				msg: "点击啦"
			});
		};
		DemoImage.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{style: "background: #f2f2f2;"},
				apivm.h(nav_bar_default, {onBack: this.back}, "Image"),
				apivm.h(
					"scroll-view",
					null,
					apivm.h(
						...
						apivm.h(
							"avm-space",
							{wrap: true},
							apivm.h("avm-image", {src: this.data.demoSrc})
						)
					),
					apivm.h(
						DemoBlock,
					...
					apivm.h(
						DemoBlock,
						{title: "加载失败"},
						apivm.h("avm-image", {src: "/404", width: 100, height: 100})
					)
				)
			);
		};
	...
	DemoImage.csslink = ["../../components/avm-ui/demos/index.css"];
	apivm.define("demo-image", DemoImage);
	apivm.render(apivm.h("demo-image", null), "body");
})();
