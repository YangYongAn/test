(function() {
	...
	var AvmBaseRadioGroup = /*@__PURE__*/ (function(Component) {
		function AvmBaseRadioGroup(props) {
			Component.call(this, props);
			this.data = {};
		}

		if (Component) AvmBaseRadioGroup.__proto__ = Component;
		AvmBaseRadioGroup.prototype = Object.create(Component && Component.prototype);
		AvmBaseRadioGroup.prototype.constructor = AvmBaseRadioGroup;
		AvmBaseRadioGroup.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseRadioGroup.prototype.radiogroupChanged = function(e) {
			api.toast({
				msg: JSON.stringify(e.detail.value)
			});
		};
		AvmBaseRadioGroup.prototype.render = function() {
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "RadioGroup"),
				apivm.h(
					DemoBlock,
					{title: "基础用法"},
					apivm.h(
						"radio-group",
						{class: "group", onchange: this.radiogroupChanged},
						apivm.h(
							"label",
							{class: "radio_label"},
							apivm.h("radio", {
								color: "#9ac200",
								value: "radio_one",
								class: "radio_label_icon"
							}),
							apivm.h("text", {class: "radio_label_text"}, "选项一")
						),
						apivm.h(
							"label",
							{class: "radio_label"},
							...
							apivm.h("text", {class: "radio_label_text"}, "选项二")
						)
					)
				),
				apivm.h(
		...
		return AvmBaseRadioGroup;
	})(Component);
	AvmBaseRadioGroup.css = {
		".page": {
			width: "100%",
			height: "100%",
			background: "#f2f2f2",
		...
		".radio_label": {margin: "8px 0"},
		".radio_label_icon": {marginRight: "8px", width: "22px", height: "22px"},
		".radio_label_text": {fontSize: "14px", color: "#333"}
	};
	apivm.define("avm-base-radio-group", AvmBaseRadioGroup);
	apivm.render(apivm.h("avm-base-radio-group", null), "body");
})();
