(function() {
	...
	var Test = /*@__PURE__*/ (function(Component) {
		...
		Test.prototype.toggle1 = function() {
			this.data.visible1 = !this.data.visible1;
		};
		Test.prototype.toggle2 = function() {
			this.data.visible2 = !this.data.visible2;
		};
		Test.prototype.toggle3 = function() {
			this.data.visible3 = !this.data.visible3;
		};
		Test.prototype.toggle4 = function() {
			this.data.visible4 = !this.data.visible4;
		};
		Test.prototype.toggle5 = function() {
			this.data.visible5 = !this.data.visible5;
		};
		Test.prototype.afterShow = function() {
			api.alert({
				msg: "afterShow"
			});
		};
		Test.prototype.render = function() {
			...
			return apivm.h(
				"safe-area",
				{class: "page"},
				apivm.h("avm-nav-bar", {onBack: this.back}, "Mask"),
				apivm.h(
					"view",
				...
				apivm.h(
					...
					apivm.h("view", {class: "overlayContent"}, apivm.h("text", null, "内容"))
				),
