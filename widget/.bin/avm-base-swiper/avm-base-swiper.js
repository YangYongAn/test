(function() {
	...
	var AvmBaseSwiper = /*@__PURE__*/ (function(Component) {
		function AvmBaseSwiper(props) {
		...
		if (Component) AvmBaseSwiper.__proto__ = Component;
		AvmBaseSwiper.prototype = Object.create(Component && Component.prototype);
		AvmBaseSwiper.prototype.constructor = AvmBaseSwiper;
		AvmBaseSwiper.prototype.back = function() {
			api.closeWin();
		};
		AvmBaseSwiper.prototype.apiready = function() {
			var customSwiper = document.getElementById("customSwiper");
			customSwiper.load({
				data: this.data.dataList
			});
		};
		AvmBaseSwiper.prototype.onchange = function(e) {
			this.data.current = e.detail.current;
		};
		AvmBaseSwiper.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"safe-area",
				{class: "page"},
						...
						apivm.h(
							...
							apivm.h("swiper", {
								...
								$bindCell_: function(celltype, item, index) {
									return apivm.h(
										"swiper-item",
										{class: "swiper-item", reusable: true},
										apivm.h("text", {class: "desc"}, item)
									);
								}
							}),
							apivm.h(
		...
		return AvmBaseSwiper;
	})(Component);
	AvmBaseSwiper.css = {
		".page": {width: "100%", height: "100%", background: "#f2f2f2"},
		".swiper": {width: "100%", height: "200px", backgroundColor: "#9ac200"},
		".swiper-item": {justifyContent: "center"},
		".title": {padding: "10px 0", fontSize: "20px"},
		".desc": {width: "100%", textAlign: "center", color: "#fff"},
		...
		".indicator-item-normal": {backgroundColor: "#999"},
		".indicator-item-active": {backgroundColor: "#fff", width: "20px"}
	};
	apivm.define("avm-base-swiper", AvmBaseSwiper);
	apivm.render(apivm.h("avm-base-swiper", null), "body");
})();
